...
func (c *categoryClient) Info(ctx context.Context, in *InfoReq, opts ...grpc.CallOption) (*CategoryInfo, error) {
	out := new(CategoryInfo)
	err := c.cc.Invoke(ctx, "/category.Category/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CategoryServer interface {
	Info(context.Context, *InfoReq) (*CategoryInfo, error)
...
func (UnimplementedCategoryServer) Info(context.Context, *InfoReq) (*CategoryInfo, error) {
...
func _Category_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/category.Category/Info",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServer).Info(ctx, req.(*InfoReq))
	}
