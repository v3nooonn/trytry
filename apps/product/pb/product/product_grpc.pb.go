...
func (c *productClient) Info(ctx context.Context, in *InfoReq, opts ...grpc.CallOption) (*Production, error) {
	out := new(Production)
...
type ProductServer interface {
	...
	Info(context.Context, *InfoReq) (*Production, error)
...
func (UnimplementedProductServer) Info(context.Context, *InfoReq) (*Production, error) {
